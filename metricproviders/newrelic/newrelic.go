...
func (p *Provider) Run(run *v1alpha1.MetricRun, metric v1alpha1.Metric) v1alpha1.Measurement {
...
func (p *Provider) Resume(run *v1alpha1.MetricRun, metric v1alpha1.Metric, measurement v1alpha1.Measurement) v1alpha1.Measurement {
...
func (p *Provider) Terminate(run *v1alpha1.MetricRun, metric v1alpha1.Metric, measurement v1alpha1.Measurement) v1alpha1.Measurement {
...
func (p *Provider) GarbageCollect(run *v1alpha1.MetricRun, metric v1alpha1.Metric, i int) error {
	return nil
}
