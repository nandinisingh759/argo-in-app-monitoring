...
// pod spec labels.
func newJobName(run *v1alpha1.MetricRun, metric v1alpha1.Metric) string {
...
func getJobIDSuffix(run *v1alpha1.MetricRun, metricName string) int {
...
func newMetricJob(run *v1alpha1.MetricRun, metric v1alpha1.Metric) (*batchv1.Job, error) {
	job := batchv1.Job{
...
func (p *JobProvider) Run(run *v1alpha1.MetricRun, metric v1alpha1.Metric) v1alpha1.Measurement {
	ctx := context.TODO()
...
func (p *JobProvider) Resume(run *v1alpha1.MetricRun, metric v1alpha1.Metric, measurement v1alpha1.Measurement) v1alpha1.Measurement {
...
func (p *JobProvider) Terminate(run *v1alpha1.MetricRun, metric v1alpha1.Metric, measurement v1alpha1.Measurement) v1alpha1.Measurement {
	jobName, err := getJobName(measurement)
	if err != nil {
		return metricutil.MarkMeasurementError(measurement, err)
	}
...
func (p *JobProvider) GarbageCollect(run *v1alpha1.MetricRun, metric v1alpha1.Metric, limit int) error {
